...
<p style="color: teal; font-weight: bold;">> Ticket 1 | working screenshot :</p>

![GraphQL response](./resources/ticket_1/graphql_response.png)
...
<p style="color: teal; font-weight: bold;">> Ticket 2 | working screenshot :</p>

![GraphQL response](./resources/ticket_2/graphql_response.png)
...
<p style="color: teal; font-weight: bold;">> Ticket 6 | working screenshot :</p>

![GraphQL response](./resources/ticket_3_4_5_6/image.png)
...
Note: add client header in request
...

{
	...
	"metadata": {
		"requestId": "cfcb4ca8-4f25-4174-8575-b5a0c8089e4d"
	}
}
...

{
	...
	"metadata": {
		"requestId": "598c51be-91db-4037-80a0-6e2cb661863f"
	}
}
```